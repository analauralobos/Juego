...
public class AvionVerdeMayor extends Enemigo {

    public AvionVerdeMayor(String filename, int x, int y, boolean shot) {
        super(filename);
        this.cajaColision = new Rectangle((int) x, (int) y, 80, 80);
        spritePosition = 1;
        this.positionX = x;
        this.positionY = y;
        ...
        if (estado == estadoEnemigo.VIVO && this.isVisible) {
            ...
            try {
                ...
                if (spriteCounter > 10) {
                    ...
                    imagen = ImageIO.read(getClass().getResource("imagenes/AvionVerdeMayor" + spritePosition + ".png"));
                    spriteCounter = 0;
                }
    ...
    public void display(Graphics2D g2) {
        g2.drawImage(imagen, (int) this.positionX, (int) this.positionY, 120, 120, null, null);
    ...
    public void restaurar() {
        ...
        try {
            this.imagen = ImageIO.read(getClass().getResource("imagenes/AvionVerdeMayor1.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
